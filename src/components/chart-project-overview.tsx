...
export function ChartProjectOverview() {
  ...
  return (
    <Card className="@container/card">
      <CardHeader>
        <CardTitle>График сессий</CardTitle>
        <CardDescription>
          <span className="hidden @[540px]/card:block">За последние 3 месяца</span>
          <span className="@[540px]/card:hidden">За последние 3 месяца</span>
        </CardDescription>
        <CardAction>
          <ToggleGroup
            type="single"
